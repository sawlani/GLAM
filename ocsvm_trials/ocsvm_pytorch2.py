...
def train(model, rho, optimizer, X, nu = 0.1):    
    ...
    loss2 = torch.dot(weights,weights)/2
    print("rho=%f" % rho)
#    print(loss.shape)
#    print(rho.shape)
    loss3 = -(1/nu)*rho.squeeze()
...
for epoch in range(epochs):
    loss_value = train(model, rho, optimizer, X)
